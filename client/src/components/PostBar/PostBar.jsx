...
function PostBar() {
    ...
    return (
        <div className='flex flex-row justify-between items-center bg-white text-black w-56.25 h-10 mx-auto rounded-3xl absolute left-1/2 -translate-x-1/2 top-2.5'>
