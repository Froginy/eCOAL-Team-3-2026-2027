...
function Home() {
  ...
  return (
    <div className="relative max-h-[300vh]">
      <div
        className="relative h-screen w-screen z-0"
      >
        ...
        <div className="flex justify-center items-center mb-10 h-[10vh]">
          ...
          >
            ...
            />
            <path
              d="M49.4569 3.04515C49.6683 2.55288 50.2269 2.31681 50.7239 2.49991L50.7735 2.51969L53.9547 3.8859C54.447 4.09731 54.6831 4.65593 54.5 5.15292L54.4803 5.20244L53.1142 8.38364C53.0129 8.61944 52.8251 8.80742 52.5894 8.90886C52.3537 9.0103 52.088 9.01746 51.8472 8.92888L51.7977 8.9091L48.6164 7.54289C48.1241 7.33147 47.888 6.77286 48.0711 6.27586L48.0908 6.22634L49.4569 3.04515Z"
              fill="white"
            />
            <path
